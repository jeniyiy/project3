...
<div class="col-md-10 p-5 pt-5">
	<a href="iBuku.php" class="btn btn-info">[+] Tambah Data Buku</a>
	...
	<tbody>
		<?php
			...
			while($perpustakaan = mysqli_fetch_array($query)){
				...
				echo "<td>";
				echo "<a
						href='editBuku.php?kode_buku=".$perpustakaan['kode_buku']."' class='btn btn-info'>Edit</a>";
				echo "<a
						href='hapusBuku.php?kode_buku=".$perpustakaan['kode_buku']."' class='btn btn-danger'>Hapus</a>";
				echo "</td>";
				echo "</tr>";
