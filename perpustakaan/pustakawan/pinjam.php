...
<div class="col-md-10 p-5 pt-5">
    <h2 class="text-center">Formulir Peminjaman Buku</h2>
    <h2 class="text-center">Perpustakaan SMKN 1 Cibinong</h2><hr>

<form action="aksiPinjam.php" method="POST">
    <div class="mb-3 row">
    ...
    <div class="col-sm-5">
        <input type="text" class="form-control" value="<?php echo $kode_buku; ?>" readonly>
    </div>
    </div>
  ...
  <a href="peminjaman.php" class="btn btn-success">BATAL</a>
  </div>
</div>
</form>
