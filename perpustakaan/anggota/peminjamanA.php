...
<h2 class="text-center">DAFTAR BUKU & PEMINJAMAN | PERPUSTAKAAN SMKN 1 CIBINONG</h2>
	...
	<tbody>
		<?php
			...
			while($perpustakaan = mysqli_fetch_array($query)){
				...
				echo "<td>";
				echo "<a
						href='iPinjamA.php?kode_buku=".$perpustakaan['kode_buku']."' class='btn btn-info'>Pinjam</a>";
				echo "</td>";
				echo "</tr>";
